...
export const Role = (props: IRoleProps) => {
  ...
  const { roleList, match } = props;
  return (
    <div>
      <h2 id="role-heading">
        <Translate contentKey="codeRevealsApplicationApp.role.home.title">Roles</Translate>
        <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
          <FontAwesomeIcon icon="plus" />
          &nbsp;
          <Translate contentKey="codeRevealsApplicationApp.role.home.createLabel">Create new Role</Translate>
        </Link>
      </h2>
      <div className="table-responsive">
        {roleList && roleList.length > 0 ? (
          <Table responsive>
            <thead>
              <tr>
                ...
                <th>
                  <Translate contentKey="codeRevealsApplicationApp.role.name">Name</Translate>
                </th>
                <th />
              </tr>
            </thead>
          ...
          <div className="alert alert-warning">
            <Translate contentKey="codeRevealsApplicationApp.role.home.notFound">No Roles found</Translate>
          </div>
        )}
      </div>
    </div>
