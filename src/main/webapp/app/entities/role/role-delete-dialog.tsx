...
export const RoleDeleteDialog = (props: IRoleDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="codeRevealsApplicationApp.role.delete.question">
        <Translate contentKey="codeRevealsApplicationApp.role.delete.question" interpolate={{ id: roleEntity.id }}>
