...
export const CandidateDeleteDialog = (props: ICandidateDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="codeRevealsApplicationApp.candidate.delete.question">
        <Translate contentKey="codeRevealsApplicationApp.candidate.delete.question" interpolate={{ id: candidateEntity.id }}>
      ...
      <ModalFooter>
        ...
        <Button id="jhi-confirm-delete-candidate" color="danger" onClick={confirmDelete}>
