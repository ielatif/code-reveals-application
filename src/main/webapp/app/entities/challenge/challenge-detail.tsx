...
export const ChallengeDetail = (props: IChallengeDetailProps) => {
  ...
  return (
    <Row>
      <Col md="8">
        <h2>
          <Translate contentKey="codeRevealsApplicationApp.challenge.detail.title">Challenge</Translate> [<b>{challengeEntity.id}</b>]
        </h2>
        <dl className="jh-entity-details">
          ...
          <dd>{challengeEntity.description}</dd>
          <dt>
            <Translate contentKey="codeRevealsApplicationApp.challenge.role">Role</Translate>
          </dt>
          <dd>{challengeEntity.role ? challengeEntity.role.id : ''}</dd>
        </dl>
        <Button tag={Link} to="/challenge" replace color="info">
