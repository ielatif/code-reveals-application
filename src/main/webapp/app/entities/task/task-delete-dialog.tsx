...
export const TaskDeleteDialog = (props: ITaskDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="codeRevealsApplicationApp.task.delete.question">
        <Translate contentKey="codeRevealsApplicationApp.task.delete.question" interpolate={{ id: taskEntity.id }}>
