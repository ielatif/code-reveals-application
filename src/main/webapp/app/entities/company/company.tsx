...
export const Company = (props: ICompanyProps) => {
  ...
  const { companyList, match } = props;
  return (
    <div>
      <h2 id="company-heading">
        <Translate contentKey="codeRevealsApplicationApp.company.home.title">Companies</Translate>
        <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
          <FontAwesomeIcon icon="plus" />
          &nbsp;
          <Translate contentKey="codeRevealsApplicationApp.company.home.createLabel">Create new Company</Translate>
        </Link>
      </h2>
      <div className="table-responsive">
        {companyList && companyList.length > 0 ? (
          ...
          <div className="alert alert-warning">
            <Translate contentKey="codeRevealsApplicationApp.company.home.notFound">No Companies found</Translate>
          </div>
        )}
      </div>
    </div>
