...
export const CompanyDeleteDialog = (props: ICompanyDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="codeRevealsApplicationApp.company.delete.question">
        <Translate contentKey="codeRevealsApplicationApp.company.delete.question" interpolate={{ id: companyEntity.id }}>
